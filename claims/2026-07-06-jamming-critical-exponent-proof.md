...
---
## The claim
Giorgio Parisi (Nobel laureate) and Francesco Zamponi, both at La Sapienza
...
- Claude was first asked to **reproduce the earlier numerical calculations**,
  then to **explain why** the a + b = 1 relationship holds.
- Per Zamponi: "Quite quickly, Claude came up with an initial idea that was
  essentially correct." The researchers then revised/tightened it into a full
  proof; the final solution turned out **simpler than expected**.
- The proof confirms that two independent theoretical routes to jamming yield
  the same physical law.
- Published **1 July 2026** in the *Journal of Statistical Mechanics: Theory and
  Experiment* (JSTAT), "A proof of an identity for the critical exponents of
  jamming."

Reported via [EurekAlert](https://www.eurekalert.org/news-releases/1133306),
July 2026.
...
- Distinguish the *result* (already published, peer-reviewed identity) from the
  *narrative* (AI produced the key idea). The former is likely solid; the latter
...
- [x] **+1 month** (2026-08-06) — No material developments since the 1-week check. No independent analysis of the released [Zenodo conversation logs](https://zenodo.org/records/20633432) has surfaced, no third party has attempted to replicate or re-derive the argument, no domain physicist has publicly challenged either the identity or the AI-authorship framing, and the [JSTAT record](https://iopscience.iop.org/article/10.1088/1742-5468/ae7bd7) carries no correction or erratum. Media/public interest appears to have moved on after the late-June/early-July press wave (Gizmodo, Live Science, phys.org, EurekAlert) without deeper technical follow-up from Parisi or Zamponi. Correction to the prior entry: the Will Sawin "pattern-finding, not proof-generating" quote traced back to a *different* story (an OpenAI/unit-distance-problem piece), not this one — there is in fact no outside domain-physicist commentary on this claim at all, which if anything makes the self-report framing weaker, not stronger. Status held at partially-confirmed: the physics remains solid and uncontested; the AI-as-engine narrative is still resting entirely on the authors' own account, now frozen rather than accumulating scrutiny.
- [ ] **+3 months** (2026-10-06) —
- [ ] **+6 months** (2027-01-06) —
- [ ] **+1 year** (2027-07-06) —
